...
fun main() {
    var cardType: String = "VKpay" // тип карты
    var transferAmount: Int = 0  // сумма перевода
    var previousMonthTransferAmount: Int = 0  // предыдущийМесяцСуммаПеревода
    val comission = comissionAmount( // комиссияСумма
        "Мир",
        55_000,
        25_000
